...
export type MeetingStatus = "scheduled" | "completed" | "cancelled" | "no_show" | "completed_no_recording";
export type TranscriptStatus = "none" | "pending" | "processing" | "ready" | "failed" | "skipped";
export type DebriefStatus = "not_needed" | "pending" | "sent" | "confirmed" | "needs_manual" | "failed";
export type CallOwner = "ben" | "evyatar" | "shared";
