...
const statusColors: Record<string, string> = {
  ...
  watched_vsl: "bg-amber-50 text-amber-700",
  got_wa: "bg-amber-50 text-amber-700",
  filled_questionnaire: "bg-amber-50 text-amber-700",
  sales_call: "bg-amber-50 text-amber-700",
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-6">
            ...
            <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2 mt-1 flex-wrap">
                    ...
                    <span
                      className={clsx(
                        ...
                        statusColors[lead.current_status] || "bg-gray-50 text-gray-700"
                      )}
                    >
              ...
              <div className="flex items-center gap-2">
                {lead.phone && (
                  <a
                    href={`tel:${lead.phone}`}
                    className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium bg-gray-50 hover:bg-gray-100 transition-colors"
                  >
                    <Phone size={16} /> התקשר
                  </a>
                )}
          ...
          {/* ── Contact info card ── */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h2 className="text-sm font-bold text-gray-700 mb-4">פרטי קשר</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {lead.phone && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm" dir="ltr">{lead.phone}</div>
                  </div>
                </div>
              )}
              ...
              {lead.occupation && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-gray-400">תחום עיסוק</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm">{sourceLabels[lead.source] || lead.source}</div>
                </div>
              </div>
              ...
              {lead.ad_name && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-gray-400">מודעה</div>
                    <div className="text-sm">{lead.ad_name}</div>
                  </div>
                </div>
              )}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-gray-400">תאריך הרשמה</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h2 className="text-sm font-bold text-gray-700 mb-5">התקדמות במשפך</h2>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span
                        className={clsx(
                          ...
                          completed ? "text-brand-600 font-medium" : "text-gray-400"
                        )}
                      >
          ...
          {/* ── Notes section ── */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h2 className="text-sm font-bold text-gray-700 mb-4">הערות</h2>
            ...
            <form onSubmit={handleAddNote} className="mb-5">
              <textarea
                ...
                rows={3}
                className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-200 focus:border-brand-400 resize-none transition-colors"
              />
          ...
          {lead.customer && (
            <Link
              ...
              className="block bg-green-50 rounded-2xl p-5 shadow-sm border border-green-100 hover:bg-green-100 transition-colors group"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-green-800">הפך ללקוח</div>
                    ...
                    .map((event) => {
                      ...
                      return (
                        <div key={event.id} className="flex gap-3 relative">
                          <div className="w-3.5 h-3.5 rounded-full mt-1 flex-shrink-0 z-10 ring-2 ring-white bg-brand-500" />
